...
borrar_button = tk.Button(historial_window, text="Borrar Historial", command=borrar_historial)
...
iteraciones_text_widget = tk.Text(iteraciones_frame, wrap="none", height=10, width=70)
...
historial_button = tk.Button(ventana, text="Mostrar Historial", command=mostrar_historial_emergente)
